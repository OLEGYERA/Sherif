...
@section("css_files")
    ...
    loadCSS("assets/css/catalog/_main.css");                //User Styles: Main
    @if($is_admin)
        loadCSS("assets/css/_main_admin.css");                //User Styles: Main
    @endif
    loadCSS("assets/css/catalog/_media.css");               //User Styles: Media
    @if($is_admin)
    ...
    <div class="sherif_center_column">
        ...
        <div class="sherif-catalog">
            <ul class="sherif-breadcrumb">
                ...
                <li><a href="#">Военное снаряжение, обмундирование, бронежилеты</a></li>
                <li><span>Вы здесь <i class="fas fa-arrow-right"></i></span>Аптечки и первая помощь</li>
            </ul>
                                    ...
                                    <div class="panel-body">
                                        <div>
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/multicam.png);background-repeat: no-repeat;background-size: cover;">
                                            ...
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/woodland.png);background-repeat: no-repeat;background-size: cover;">
                                            ...
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/A-TACS.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> A-TACS
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/A-TACS-AU.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> A-TACS AU
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/A-TACS-FG.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> A-TACS FG
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/ACU.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> ACU
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/MTP.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> MTP
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/mossy-oak.png);background-repeat: no-repeat;background-size: cover;">
                                            ...
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/cadpat.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> Cadpat
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/flexktarn.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> Flacktarn
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/AT-Digital.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> AT-Digital
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/Digital.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> Digital
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/Khaki.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> Khaki
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/FG.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> FG
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/OliveDrab.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> Olive Drab
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/AOR-1.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> AOR 1/2
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/desert-dpm2.png);background-repeat: no-repeat;background-size: cover;">
                                            ...
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/ССЕTarn1.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> CCE Tarn
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/DDPM2.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> DDPM
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/tree2.png);background-repeat: no-repeat;background-size: cover;">
                                            ...
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/dpm_urban_b_.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> Urban
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/Kruptek.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> Kruptek
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/Varan.png);background-repeat: no-repeat;background-size: cover;">
                                                <input type="checkbox" name=""> Varan
                                            </div><br />
                                            <div class="colors"  style="
								                                    		background: url(img/pic/filter/MARPAT.png);background-repeat: no-repeat;background-size: cover;">
